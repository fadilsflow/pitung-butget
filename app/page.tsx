...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen ">
      <header className="px-5 lg:px-6 h-14 flex items-center border-b">
      ...
      <main className="flex-1">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800">
          <div id="featutes" className="container px-5">
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-5 border-t">
